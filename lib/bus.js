...
class MessageBus extends EventEmitter {
  ...
  constructor (conn) {
    ...
    const handleMessage = (msg) => {
      ...
      } else { // methodCall (needs to be handled)
        let handled = false;
   ...
   *
   * @param {string} name - the well-known name on the bus to request.
   * @param {NameFlag} [flags] - DBus name flags which affect the behavior of taking the name.
